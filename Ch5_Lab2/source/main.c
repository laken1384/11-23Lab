...
void maxmum(int grades[][EXAM], int pupils, int tests);
...
int main()
{
	void(*pricessGrades[4])(int grades[][EXAM], int, int)
		= { printArray ,minmum ,maxmum ,average };
	int choice = 0;
	...
	while (choice != 4)
	{
		...
		if (choice != 4)
		{
			(*pricessGrades[choice])(studentGrades, STUDENTS, EXAM);
		}
		else
		{
...
void printMenu(void)
{
	printf("\n\tEnter a choice:\n"
		...
		"\t 1 Find the maxmum grade\n"
		"\t 2 Find the minmum grade\n"
